...
export async function createTransactionReturn(req, res) {
    try {
        ...
        //   });
        // }
        const totalRent = ((returnDataInMili - issuedDataInMili) / (24 * 60 * 60 * 1000) + 1) *
            isBookExist.rentPerDay;
        const updatedTransaction = await Transaction.updateOne({ bookId, userId }, {
            $set: {
                returnDate,
                totalRent,
            },
...
export async function getUsersWithSameBook(req, res) {
    try {
...
export async function getTotalRentWithBook(req, res) {
    try {
...
export async function getBooksWithUser(req, res) {
    try {
...
export async function getTransactionsBetweenRange(req, res) {
    try {
